...
import pl.edu.pja.tpo08.ApplicationError;
import pl.edu.pja.tpo08.Code;
import pl.edu.pja.tpo08.service.CodeService;
import pl.edu.pja.tpo08.service.FormatterService;
...
public class FormatterController {
    ...
    public String code(@RequestParam String id, Model model) {
        ...
        if (code.isEmpty()) {
            model.addAttribute("error", new ApplicationError("No such ID", "Could not find a code snippet with this id."));
            return "invalidID";
        }
